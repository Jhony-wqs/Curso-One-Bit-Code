interface GithubUserResponse {
  ...
  interface GithubRepoResponse {
    ...
    full_name: string
    private: boolean
    // Omit e uma propriedade do tipo genérica para omitir algumas propriedades onde ja tem em outras interfaces assin não aparendo noa autocomplite.
 ...
 // Tipo Omit
  ...
  // Tipo Pick  ao contrario o omit, nós podemos pegar so as propriedades deixando
  //  assim mais fácil o autocompleta da interface.
