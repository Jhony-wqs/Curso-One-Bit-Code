// Define a interface para a resposta da API do Github para um usuário
interface GithubUserResponse {
    ...
    repos_url: string // URL para os repositórios do usuário
    message?: "Not Found" // Mensagem opcional para quando o usuário não é encontrado
}

// Define uma interface para a resposta da API do Github para um repositório
interface GithubRepoResponse {
    ...
    stargazers_count: number // Número de estrelas do repositório
}
...
async function fetchUser(nameUser: string) {
