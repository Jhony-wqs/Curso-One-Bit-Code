  ...
  return (
    <article className={styles.post}>
      ...
      <div className={`${styles.postContent}`}>
        <Image src="/imagem/image.png" alt="Saturno no espaço" width={600} height={307} />
        <p>
        ...
        <Image src="/imagem/saturno.jpeg" alt="Anéis de Saturno" width={600} height={328} />
        ...
        <Image src="/imagem/imagem_2025-11-25_063832488.webp" alt="Luas de Saturno" width={600} height={315} />
      </div>
