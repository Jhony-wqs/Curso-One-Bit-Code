        ...
        <main>
            ...
            <div style={{
                ...
                <div style={{display: "flex", gap:'1rem'}}>
                    <Link href={`/spaceships/${+id - 1}`} className="btn" style={{display: +id === 1 ? 'none' : 'block'}}>Anterior</Link>

                    <Link href={`/spaceships/${+id + 1}`} className="btn"
                    style={{display: +id === spaceships.length ? 'none' : 'block'}}>Próximo</Link>
