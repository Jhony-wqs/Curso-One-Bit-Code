...
const products = [
  {
    id: 1,
    image: {
      src: "https://www.apple.com/v/mac/home/ca/images/overview/select/product_tile_mbp_14_16__bkl8zusnkpw2_large.png", // adicione a URL manualmente
      alt: "Macbook Air",
      width: 354,
      height: 176,
    },
...

  {
    id: 2,
    image: {
      src: "https://www.apple.com/v/mac/home/ca/images/overview/select/product_tile_mba_13_15__fx2g3qlubdym_large.png", // adicione a URL manualmente
      alt: "Macbook Pro",
      width: 354,
      height: 176,
    },
        ...
        {products.map((product)=> (
          <article key={product.id}>
            ...
            <div className="btn-group">
              <a className="btn primary" href="#">Saiba mais</a>
              <a className="btn outline" href="#">Comprar</a>
            </div>
          </article>
        ))}
      </div>
